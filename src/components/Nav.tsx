        ...
        <div className="flex items-center gap-5 text-sm text-[var(--color-muted)]">
          {showSections && (
            <>
              ...
              <a href="#projects" className="hidden sm:inline hover:text-[var(--color-ink)] transition-colors">Projects</a>
              <a href="#certifications" className="hidden sm:inline hover:text-[var(--color-ink)] transition-colors">Documents</a>
            </>
          )}
          <a
            href={profile.cv}
